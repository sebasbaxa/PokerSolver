...
class TestCFR(unittest.TestCase):
    ...
    def test_IP_values(self):
        ...
        oop_range.add_suited_cards('K', 'Q')  # KQs
        oop_range.add_pocket_pair('K')  # KK

        ip_range = PlayerRange('IP')
        ip_range.add_pocket_pair('A')  # AA
        ip_range.add_suited_cards('K', 'Q')  # KQs
        ip_range.add_pocket_pair('K')  # KK
